      ...
      <form autoComplete = 'off'>
        <Paper square>
          <div className = {classes.editRequired}>
            ...
            <Grid container spacing = {32} direction = 'row' justify = 'center' className = {classes.rowInputs}>
              <Grid item xs = {3}>
                <Typography variant = 'button' align = 'left' className = {classes.typoTitle}>Phone Number </Typography>
              </Grid>
              <Grid item xs = {2}>
              ...
              <Grid item xs = {5}>
                <Tooltip title="Private" placement="right-start" classes={{ tooltip: classes.lightTooltip }}>
                  ...
                  >
                    ...
                    />
                    <FormHelperText id = 'phone-helper-text'>The number for guest contacts, booking requests, reminders,
            ...
            <Grid container spacing = {32} direction = 'row' justify = 'center' className = {classes.rowInputs}>
              <Grid item xs = {3}>
                <Typography variant = 'button' align = 'left' className = {classes.typoTitle}>Email Address </Typography>
              </Grid>
              <Grid item xs = {7}>
                <Tooltip title="Private" placement="right-start" classes={{ tooltip: classes.lightTooltip }}>
                  <FormControl
                  ...
                  >
                    ...
                    />
                    <FormHelperText id = 'email-helper-text'>We won’t share your private email address with anyone else</FormHelperText>
                  </FormControl>
                </Tooltip>
              </Grid>
            </Grid>
            <Grid container spacing = {32} direction = 'row' justify = 'center' className = {classes.rowInputs}>
              <Grid item xs = {3}>
                <Typography variant = 'button' align = 'left' className = {classes.typoTitle}>Date of birth </Typography>
              </Grid>
              <Grid item xs = {2}>
                <Tooltip title="Private" placement="right-start" classes={{ tooltip: classes.lightTooltip }}>
                <TextField
            ...
            <Grid container spacing = {32} direction = 'row' justify = 'center' className = {classes.rowInputs}>
              ...
              <Grid item xs = {7}>
                ...
                >
                  ...
                  />
                  <FormHelperText id = 'emergencyContact-helper-text'>Give our Customer Experience team a trusted
                                                                      contact we can alert in an urgent
                                                                      situation.</FormHelperText>
                </FormControl>
                </Tooltip>
              </Grid>
            </Grid>
